...
/*   Updated: 2019/03/20 16:29:55 by cpireyre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_list	*ft_lstpluck(t_list *curr, t_list *todel, void (*del)(void *, size_t));
t_list	*ft_lstnew(void const *content, size_t sz) __attribute__((malloc));
t_list	*ft_lstmap(t_list *l, t_list *(*f)(t_list *)) __attribute__((malloc));
...
t_list	*ft_lstsort(t_list *list, int (*compare)(t_list *one, t_list *two));
