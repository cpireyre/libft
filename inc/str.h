...
void		ft_strdel(char **ap) __attribute__((always_inline));
char		*ft_itoa_base(int n, int base) __attribute__((MALLOC_CONST));
char		*ft_itoa(int n) __attribute__((MALLOC_CONST_INLINE));
char		*ft_strmap(char const *s, char (*f)(char)) __attribute__((malloc));
char		*ft_strnew(size_t l) __attribute__((MALLOC_CONST_INLINE));
char		*ft_strdup(const char *str) __attribute__((MALLOC_INLINE));
char		*ft_strjoin(char const *s1, \
char const *s2) __attribute__((MALLOC_INLINE));
...
size_t		ft_strsplen(const char *str) __attribute__((PURE_INLINE));
size_t		ft_strlen(const char *s) __attribute__((PURE_INLINE));
int			ft_strcmp(const char *s1, \
const char *s2) __attribute__((PURE_INLINE));
int			ft_strncmp(const char *s1, \
const char *s2, size_t n) __attribute__((PURE_INLINE));
...
char const *s2) __attribute__((PURE_INLINE));
int			ft_strnequ(char const *s1, \
char const *s2, size_t n) __attribute__((PURE_INLINE));
...
void		ft_strclr(char *s) __attribute__((always_inline));
void		ft_striteri(char *s, void (*f)(unsigned int, char *));
void		ft_striter(char *s, void (*f)(char *));
char		*ft_strcat(char *b, const char *a) __attribute__((always_inline));
